...
if ( ! class_exists( 'WP_REST_Menus' ) ) :
    ...
    class WP_REST_Menus {
        ...
        public function register_routes() {
            ...
            register_rest_route( self::api_namespace(), '/'.$base, array(
                array(
            ...
            register_rest_route( self::api_namespace(), '/'.$base.'/(?P<id>\d+)', array(
                array(
                    'methods'  => WP_REST_Server::READABLE,
            ...
            register_rest_route( self::api_namespace(), '/menu-locations', array(
                array(
                    'methods'  => WP_REST_Server::READABLE,
            ...
            register_rest_route( self::api_namespace(), '/menu-locations/(?P<location>[a-zA-Z0-9_-]+)', array(
                array(
                    'methods'  => WP_REST_Server::READABLE,
        ...
        public function format_menu_item( $menu_item, $children = false, $menu = array() ) {
            ...
            $object = $item['type'] === 'post_type' ? get_post($item['object_id']) : null;
            $menu_item = array(
                'id'       => abs( $item['ID'] ),
                ...
                'slug' => $object ? $object->post_name : null
            );
